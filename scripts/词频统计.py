...
FIAG = {'vi': '不及物动词', 's': '处所词', 'r': '代词', 'ns': '地名', 'v': '动词', 'vg': '动词性语素', 'f': '方位词', 'd': '副词', 'vd': '副动词', 'ad': '副形词', 'k': '后缀', 'nt': '机构团体名', 'uj': '结构助词1', 'uv': '结构助词2', 'p': '介词', 'c': '连词', 'q': '量词', 'n': '名词', 'ng': '名词性语素', 'vn': '名动词', 'an': '名形词', 'nz': '其它专名', 'h': '前缀', 'b': '区别词',
